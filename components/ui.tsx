    ...
    return (
      <div className={containerClassName}>
        ...
        <input
          id={inputId}
          ref={ref}
          className={`block w-full px-3 py-2 bg-slate-50 border border-slate-300 rounded-md shadow-sm placeholder-slate-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm dark:bg-slate-800 dark:border-slate-600 dark:placeholder-slate-500 ${error ? 'border-red-500' : ''}`}
          {...props}
        />
    ...
    return (
      <div className={containerClassName}>
        ...
        <select
          id={selectId}
          ref={ref}
          className={`block w-full px-3 py-2 bg-slate-50 border border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm dark:bg-slate-800 dark:border-slate-600 ${error ? 'border-red-500' : ''}`}
          {...props}
        >
          {children}
        </select>
