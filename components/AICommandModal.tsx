        ...
        <Modal isOpen={isOpen} onClose={handleCloseAndReset} title={getModalTitle()}>
            {parsedData ? (
                ...
                <div className="space-y-4">
                    ...
                    <textarea
                        rows={4}
                        className="block w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm placeholder-slate-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm dark:bg-slate-800 dark:border-slate-600 dark:placeholder-slate-500"
